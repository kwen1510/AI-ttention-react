    ...
    const defaultPrompts = [
      {
        ...
        description: "Extracts the main topics and recurring themes from the discussion",
        content: "Analyze the transcript and identify the top 3-5 key themes discussed. For each theme, provide a brief explanation and a supporting quote.",
        category: "Analysis",
        mode: "summary",
        tags: ["themes", "analysis", "summary"],
        isPublic: true,
      ...
      {
        _id: uuid(),
        title: "Evaluate Student Participation",
        description: "Analyzes student engagement levels and participation patterns",
        content: "Based on the transcript, evaluate the level of student participation. Who is speaking the most? Are there any students who are dominating the conversation? Are there any students who are not participating at all?",
        category: "Assessment",
        mode: "summary",
        tags: ["participation", "engagement", "assessment"],
        isPublic: true,
        authorName: "Smart Classroom Team",
        created_at: Date.now(),
        updated_at: Date.now(),
      ...
      },
      {
        ...
        description: "Generates thought-provoking questions to deepen the discussion",
        content: "Based on the current discussion, generate 3-5 follow-up questions that the teacher could ask to deepen student understanding and encourage critical thinking.",
        category: "Planning",
        mode: "summary",
        tags: ["questions", "planning", "critical-thinking"],
        isPublic: true,
        authorName: "Smart Classroom Team",
        created_at: Date.now(),
        updated_at: Date.now(),
